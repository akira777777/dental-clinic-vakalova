...
const doctorsData = {
  ...
  "elizaveta-vakalova": {
    ...
    about: "Елизавета Вакалова - ведущий хирург-имплантолог клиники. Специализируется на сложных случаях имплантации с использованием современных систем Nobel Biocare и Straumann. Прошла специализированное обучение в Швейцарии по костной пластике и синус-лифтингу. Выполнила более 800 успешных имплантаций.",
