        ...
        >
          {doctors.map((doctor) => (
            <motion.div
              ...
              className="group bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-card p-6 flex flex-col items-center text-center transition-all hover:shadow-xl hover:border-primary dark:hover:border-primary relative overflow-hidden"
            >
              ...
              <div className="relative z-10 w-full flex flex-col items-center">
                ...
                <div className="relative mb-5">
                  <motion.div
                    className="w-24 h-24 rounded-full overflow-hidden ring-4 ring-zinc-50 dark:ring-zinc-800 group-hover:ring-primary/30 transition-all duration-300"
                  ...
                  {doctor.rating >= 4.9 && (
                    <motion.div
                      ...
                      className="absolute bottom-0 right-0 w-6 h-6 bg-green-500 border-2 border-white dark:border-zinc-950 rounded-full flex items-center justify-center"
                      title="Top Rated"
                    >
                ...
                {/* Doctor Info */}
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white group-hover:text-primary transition-colors duration-300">
                  {doctor.name}
                </h3>
                ...
                {/* Education - compact */}
                <div className="w-full mb-4 bg-zinc-50 dark:bg-zinc-900/50 p-3 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <GraduationCap className="h-4 w-4 text-primary" />
                    <h4 className="text-sm font-semibold text-zinc-900 dark:text-white">Образование</h4>
                  </div>
                ...
                <div className="w-full mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold text-zinc-900 dark:text-white">Специализации</h4>
                  </div>
                  <div className="flex flex-wrap gap-2 justify-center">
                    {doctor.specializations.map((spec) => (
                      <motion.span
                        ...
                        className="rounded-full bg-zinc-100 dark:bg-zinc-800 px-3 py-1 text-xs font-medium text-zinc-700 dark:text-zinc-300 hover:bg-primary hover:text-white transition-colors duration-200"
                      >
                        {spec}
                      </motion.span>
                    ))}
                ...
                <div className="mt-auto w-full grid grid-cols-2 gap-3">
                  <Link href={`/doctors/${doctor.slug}`} className="w-full">
                    <Button variant="outline" className="text-sm w-full hover:border-primary hover:text-primary transition-all duration-300" size="sm">
                      Профиль
                    </Button>
                  </Link>
                  <Link href="/booking" className="w-full">
                    <Button className="text-sm shadow-sm w-full hover:shadow-lg hover:scale-105 transition-all duration-300" size="sm">
                      Записаться
                    </Button>
                  </Link>
                </div>
