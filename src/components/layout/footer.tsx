        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 mb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded p-0.5">
                <span className="material-icons-round text-base">local_hospital</span>
              </div>
              <span className="font-bold text-lg text-zinc-900 dark:text-white">Вакалова</span>
            </div>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Предоставляем заботливую, современную стоматологию для сообщества с 2010 года.
            </p>
          </div>
          ...
          {/* Company */}
          <div>
            <h4 className="font-semibold text-zinc-900 dark:text-white mb-4">Компания</h4>
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
              <li>
          ...
          {/* Legal */}
          <div>
            <h4 className="font-semibold text-zinc-900 dark:text-white mb-4">Правовая информация</h4>
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
              <li>
